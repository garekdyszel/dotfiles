...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1589374482);
user_pref("app.update.lastUpdateTime.background-update-timer", 1589374722);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1589374602);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1589385710);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1589374842);
...
user_pref("idle.lastDailyNotification", 1589375132);
user_pref("intl.accept_languages", "en-US, en");
user_pref("media.gmp.storage.version.observed", 1);
user_pref("network.cookie.prefsMigrated", true);
user_pref("network.predictor.cleaned-up", true);
user_pref("places.database.lastMaintenance", 1588962547);
